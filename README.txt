...
client ve server için npm install komutu çalıştırılır //node_modules kurulması için
------------------

client build alma
------------------

npm run build //komut satırından yazılır
...
server/dist/index.js çalıştırılır // node index.js
